...
func TestCosmosGetChannelsCharacterizesAllChannelAndPortValueCombinations(t *testing.T) {
	for mask := 0; mask < 16; mask++ {
		t.Run(fmt.Sprintf("mask-%04b", mask), func(t *testing.T) {
			srcChannel := cosmosLogCombinationValue(mask, 1, "channel-src")
			dstChannel := cosmosLogCombinationValue(mask, 2, "channel-dst")
			srcPort := cosmosLogCombinationValue(mask, 4, "port-src")
			dstPort := cosmosLogCombinationValue(mask, 8, "port-dst")
...
func TestCosmosGetChannelsCharacterizesMissingTagsAsNonNilEmpty(t *testing.T) {
	tests := []struct {
		name   string
...
func TestCosmosGetChannelsCharacterizesFirstOccurrenceAndCrossEventOrder(t *testing.T) {
	events := []provider.RelayerEvent{
...
func TestCosmosGetChannelsCharacterizesSameEventTagOrder(t *testing.T) {
	events := []provider.RelayerEvent{{Attributes: map[string]string{
		dstChanTag: "dst",
		srcChanTag: "src",
	}}}
...
func TestCosmosGetChannelsCharacterizesSingleFieldCapacityAndExactType(t *testing.T) {
...
func TestCosmosGetChannelsCharacterizesIndependentOutputAndInput(t *testing.T) {
...
func cosmosLogCombinationValue(mask, bit int, value string) string {
	if mask&bit != 0 {
		return value
	}
	return ""
