...
| cli-config | `Pantani/cx/complexity-cli-config` / `Pantani/cx/complexity-cli-version@b91cb7d` | pending publication | `cmd/config.go`, `cmd/appstate.go`, characterization/state | `configShowCmd`, `configInitCmd`, `addChainsFromDirectory`, `addPathsFromDirectory`, `updatePathConfig` | `11/20, 9/26, 8/18, 8/18, 7/11` -> `1/0, 1/0, 3/3, 4/6, 3/3`; helpers max `7/6`; original `addPathFromUserInput 10/9` unchanged and valid | `63/107/110` -> `62/102/105`; max `48/99` unchanged | 17 tests / 31 cases pass original and refactor with race; package `cmd` 114 pass | focused/race/package/local scores/lint/modules/readonly build/diff-check/inventory PASS; global `make complexity` expected FAIL with 105 | APPROVED; CodeRabbit minor rejected with characterization evidence | no collision with live #9/#10 | READY_TO_PUBLISH |
...
| pending cli-config PR | `cmd/config.go`, `cmd/appstate.go`, characterization/state | five targets removed; helpers max `7/6`; `addPathFromUserInput 10/9` unchanged | `63/107/110` -> `62/102/105` | PASS (intermediate global complexity expected red) | APPROVED / READY_TO_PUBLISH |
