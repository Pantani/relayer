...
3. Garantir que cada helper novo tenha ciclo/cognitiva `<=10/<=10`.
4. Executar formatacao, testes focais e metricas locais antes de devolver o diff.

## Principios de trabalho

- Use exclusivamente `gocyclo@v0.6.0`, `gocognit@v1.2.1` e `-over 10`.
...
- Nao aumente o threshold acima de 10, suprima, crie allowlist ou exclua codigo manuscrito.
